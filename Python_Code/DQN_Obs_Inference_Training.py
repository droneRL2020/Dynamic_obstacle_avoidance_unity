...
if check_save == 1:
    checkpoint = tf.train.get_checkpoint_state('saved_networks/2017-12-31_4_51/2017-12-31_13_23/')
    if checkpoint and checkpoint.model_checkpoint_path:
        ...
        # Initial parameters
Replay_memory = []
step = 1   # change steps to the checkpoint's last step.
score = 0
score_board = 0
maxQ_sum = 0
maxQ_board = 0
